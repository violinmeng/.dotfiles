...
(load-file "~/.config/emacs/lisp/dw-settings.el")
...
(pcase system-type
  ...
  ('darwin (set-face-attribute 'default nil :font "FiraCode Nerd Font" :height 170)))
...
(dw/leader-key-def
  ...
  "fj"  '(counsel-file-jump :which-key "jump to file"))(use-package ivy
  :diminish
  :bind (("C-s" . swiper)
         :map ivy-minibuffer-map
         ("TAB" . ivy-alt-done)	
...
(custom-set-variables
 ...
 '(package-selected-packages '(minions use-package ivy doom-modeline command-log-mode)))
(custom-set-faces
